...
SceneTensor is the fixed-length representation of a tabletop scene. It holds up to N_MAX=12
...
N_MAX: int = 12
"""Maximum number of objects in a scene. Fixed at 12 per Week 2.5 vocab finalization (12-object vocab)."""
...
class SceneTensor:
    ...
    Attributes:
        object_types: Long tensor [N_MAX] of ObjectTypeId values (0-11). Inactive slots
